...
```sh
bash <(curl -Ls https://raw.githubusercontent.com/KanekiDevPro/x-ui/master/install.sh)
```
...
```sh
VERSION=1.8.0 && bash <(curl -Ls "https://raw.githubusercontent.com/KanekiDevPro/x-ui/$VERSION/install.sh") $VERSION
```
